...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="cenik" width="100%" align="center" >
        <tr>
            <td colspan="2" align="center" style="font-size: 12px; color:#ffffff" bgcolor="#164488"  >
                <strong>ORIENTAÈNÍ CENÍK</strong></td>
        </tr>
        <tr>
            <td align="center" colspan="2" bgcolor="#164488"  style="color:#ffffff">
        ...
        <tr>
            <td colspan="2" align="center" bgcolor="#164488"  style="color:#ffffff">
        ...
        <tr>
            <td colspan="2" align="center" style="height: 17px; color:#ffffff" bgcolor="#164488"  >
